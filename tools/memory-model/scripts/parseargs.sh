...
#
# the corresponding .yat.out file, and does not judge the result.
#
...
usagehelp () {
	...
	echo "      --destdir path (place for .yat.out, default by .yat)"
	echo "      --herdopts -conf linux-kernel.cfg ..."
	echo "      --jobs N (number of jobs, default one per CPU)"
	echo "      --procs N (yat tests with at most this many processes)"
