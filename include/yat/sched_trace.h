...
#define trace_yat_task_param(t)
#define trace_yat_task_release(t)
#define trace_yat_switch_to(t)
#define trace_yat_switch_away(prev)
#define trace_yat_task_completion(t, forced)
#define trace_yat_task_block(t)
#define trace_yat_task_resume(t)
#define trace_yat_sys_release(start)
...
#define sched_trace_task_completion(t, forced)				\
	do {								\
		SCHED_TRACE2(SCHED_TRACE_BASE_ID + 6,			\
				...
				(unsigned long) forced);		\
		trace_yat_task_completion(t, forced);		\
	} while (0)
